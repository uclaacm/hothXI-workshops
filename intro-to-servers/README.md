...
This will create a boiler plate React frontend in a folder called `client` inside our `demo-app` folder. Go ahead and replace the contents of the default `client/src/App.js` file with the code I've provided in the [`App.js`](./App.js) file in this repository.
